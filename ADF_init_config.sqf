...
/********** GENERAL **********/
_ADF_mission_version = 25; // Mission version
...
_ADF_Caching_unitDistance = 500; // AI Unit caching distance default = 1000 meters.
_ADF_Caching_vehicleDistance_land = 250; // Cars caching distance default = 250 meters.
_ADF_Caching_vehicleDistance_air = 1000; // aircraft caching distance default = 250 meters.
...
/********** VIEW DISTANCE **********/
setViewDistance 750; // Default view distance.
ADF_VD_foot = 1000; // Maximum view distance on foot.
ADF_VD_vehicle = 1500; // Maximum view distance in a vehicle.
ADF_VD_air = 2000; // Maximum view distance when airborne.
...
_ADF_wTixNr = 100; // Respawn Tickets. Number available respawns for WEST Blufor.
_ADF_eTixNr = 150; // Respawn Tickets. Number available respawns for EAST Opfor.
...
_ADF_ambient_uCiv = false; // enable ambient civilian PERSONS that spawn around the player(s) [true/false].
...
_ADF_ambient_vCiv = false; // enable ambient civilians VEHICLES that spawn around the player(s) [true/false].
